    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            ...
            login_field = forms.EmailField(label=_("E-mail"),
                                           widget=login_widget)
# здесь меняем имена и внутренности поля
        elif app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.USERNAME:
            login_widget = forms.TextInput(attrs={'class': 'form-control','placeholder':
                                                  _('Логин'),
                                                  'autofocus': 'autofocus'})
...
class ResetPasswordForm(forms.Form):
    ...
    email = forms.EmailField(
        label=_("E-mail"),
        required=True,
        widget=forms.EmailInput(attrs={'class': 'form-control', 'placeholder': 'E-mail адрес',})
    )
