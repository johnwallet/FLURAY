...
class LoginView(RedirectAuthenticatedUserMixin,
    ...
    template_name = "users/account/login." + app_settings.TEMPLATE_EXTENSION
    success_url = None
...
class CloseableSignupMixin(object):
    template_name_signup_closed = (
        "users/account/signup_closed." + app_settings.TEMPLATE_EXTENSION)
...
class SignupView(RedirectAuthenticatedUserMixin, CloseableSignupMixin,
    ...
    template_name = "users/account/signup." + app_settings.TEMPLATE_EXTENSION
...
class ConfirmEmailView(TemplateResponseMixin, View):
    ...
    template_name = "users/account/email_confirm." + app_settings.TEMPLATE_EXTENSION
    ...
    def post(self, *args, **kwargs):
        ...
        get_adapter(self.request).add_message(
            self.request,
            messages.SUCCESS,
            'users/account/messages/email_confirmed.txt',
...
class EmailView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = "users/account/email." + app_settings.TEMPLATE_EXTENSION
    ...
    def form_valid(self, form):
        ...
        get_adapter(self.request).add_message(
            self.request,
            messages.INFO,
            'users/account/messages/email_confirmation_sent.txt',
        ...
        try:
            ...
            if email_address.primary:
                get_adapter(request).add_message(
                    request,
                    messages.ERROR,
                    'users/account/messages/cannot_delete_primary_email.txt',
                    {"email": email})
            else:
                ...
                get_adapter(request).add_message(
                    request,
                    messages.SUCCESS,
                    'users/account/messages/email_deleted.txt',
                    {"email": email})
                return HttpResponseRedirect(self.get_success_url())
        except EmailAddress.DoesNotExist:
            pass
        ...
        try:
            ...
            if not email_address.verified and \
                ...
                get_adapter(request).add_message(
                    request,
                    messages.ERROR,
                    'users/account/messages/unverified_primary_email.txt')
            else:
                ...
                get_adapter(request).add_message(
                    request,
                    messages.SUCCESS,
                    'users/account/messages/primary_email_set.txt')
...
class PasswordChangeView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = (
        "users/account/password_change." + app_settings.TEMPLATE_EXTENSION)
    ...
    def form_valid(self, form):
        ...
        get_adapter(self.request).add_message(
            self.request,
            messages.SUCCESS,
            'users/account/messages/password_changed.txt')
...
class PasswordSetView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = "users/account/password_set." + app_settings.TEMPLATE_EXTENSION
    ...
    def form_valid(self, form):
        ...
        get_adapter(self.request).add_message(
            self.request,
            messages.SUCCESS,
            'users/account/messages/password_set.txt')
...
class PasswordResetView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = "users/account/password_reset." + app_settings.TEMPLATE_EXTENSION
...
class PasswordResetDoneView(TemplateView):
    template_name = (
        "users/account/password_reset_done." + app_settings.TEMPLATE_EXTENSION)
...
class PasswordResetFromKeyView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = (
        "users/account/password_reset_from_key." + app_settings.TEMPLATE_EXTENSION)
...
class PasswordResetFromKeyDoneView(TemplateView):
    template_name = (
        "users/account/password_reset_from_key_done." +
...
class LogoutView(TemplateResponseMixin, View):
    ...
    template_name = "users/account/logout." + app_settings.TEMPLATE_EXTENSION
    redirect_field_name = "next"
    ...
    def logout(self):
        ...
        adapter.add_message(
            self.request,
            messages.SUCCESS,
            'users/account/messages/logged_out.txt')
...
class AccountInactiveView(TemplateView):
    template_name = (
        'users/account/account_inactive.' + app_settings.TEMPLATE_EXTENSION)
...
class EmailVerificationSentView(TemplateView):
    template_name = (
        'users/account/verification_sent.' + app_settings.TEMPLATE_EXTENSION)
