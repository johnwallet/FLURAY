$(function() {
	"use strict";
	if($("#flot-bar-1").length && $.plot("#flot-bar-1", [{
			data: [
				[0, 3],
				[2, 8],
				[4, 5],
	...
	if($("#flot-line-2").length) $.plot($("#flot-line-2"), [{
		data: [
			[0, 2],
			[1, 3],
			[2, 6],
	...
	if($("#flot-line-3").length) $.plot($("#flot-line-3"), [{
		data: [
			[0, 10],
			[1, 7],
			[2, 8],
	...
	if($("#flot-line-4").length) $.plot($("#flot-line-4"), [{
		data: [
			[0, 10],
			[1, 7],
			[2, 8],
	...
	if($("#flot-area-1").length) $.plot($("#flot-area-1"), [{
		data: o,
		label: "New Customer",
		color: "#00a7e1"
	}, {
	...
	if($("#flot-area-2").length) $.plot($("#flot-area-2"), [{
		data: o,
		label: "New Customer",
		color: "#3ddc97"
	}, {
	...
	function e() {
		...
		$("#toggle-chart input[type='checkbox']").each(function() {
			if($(this).is(":checked")) {
				var o = $(this).attr("id").replace("cbdata", "");
				e.push({
					label: "Data " + o,
					data: t[o - 1]
				})
