$(document).ready(function() {
	function o() {
		$("#sparkline1").sparkline([46, 38, 43, 35, 44, 45, 52, 46, 40], {
			...
			width: "200",
			height: "200",
			sliceColors: ["#00a7e1", "#3051d3", "#3ddc97", "#e4cc37"]
	...
	function e() {
		...
		$("html").mousemove(function(i) {
			var o = i.pageX,
				e = i.pageY; - 1 < l && (t += Math.max(Math.abs(o - l), Math.abs(e - r))), l = o, r = e
		});
		var h = function() {
			var i = (new Date).getTime();
			if(e && e != i) {
				var o = Math.round(t / (i - e) * 1e3);
				a.push(o), 30 < a.length && a.splice(0, 1), t = 0, $("#sparkline4").sparkline(a, {
			...
			e = i, setTimeout(h, 500)
		};
		setTimeout(h, 500)
	}
	var l;
	o(), e(), $(window).resize(function(i) {
