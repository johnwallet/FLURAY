...
# === РЕЗЕРВ ОБМЕННИКА ===
# БАНКИ
    reserv_sberbank_rub = models.DecimalField('РЕЗЕРВ СБЕРБАНК', max_digits=10, decimal_places=2, default=0)
    reserv_psb_rub = models.DecimalField('РЕЗЕРВ ПСБ', max_digits=10, decimal_places=2, default=0)
    reserv_tinkoff_rub = models.DecimalField('РЕЗЕРВ ТИНЬКОФФ', max_digits=10, decimal_places=2, default=0)
    reserv_gazprombank_rub = models.DecimalField('РЕЗЕРВ ГАЗПРОМБАНК', max_digits=10, decimal_places=2, default=0)
    reserv_alfabank_rub = models.DecimalField('РЕЗЕРВ АЛЬФАБАНК', max_digits=10, decimal_places=2, default=0)
    reserv_russtandart_rub = models.DecimalField('РЕЗЕРВ РУССКИЙСТАНДАРТ', max_digits=10, decimal_places=2, default=0)
    reserv_vtb_rub = models.DecimalField('РЕЗЕРВ ВТБ', max_length=50, max_digits=10, decimal_places=2, default=0)
    reserv_rosselhoz_rub = models.DecimalField('РЕЗЕРВ РОССЕЛЬХОЗБАНК', max_digits=10, decimal_places=2, default=0)
    reserv_raifaizen_rub = models.DecimalField('РЕЗЕРВ РАЙФАЙЗЕНБАНК', max_digits=10, decimal_places=2, default=0)
    reserv_roketbank_rub = models.DecimalField('РЕЗЕРВ РОКЕТБАНК', max_digits=10, decimal_places=2, default=0)
    reserv_otkritie_rub = models.DecimalField('РЕЗЕРВ ОТКРЫТИЕ', max_digits=10, decimal_places=2, default=0)
    reserv_pochtabank_rub = models.DecimalField('РЕЗЕРВ ПОЧТАБАНК', max_digits=10, decimal_places=2, default=0)
    reserv_rnkb_rub = models.DecimalField('РЕЗЕРВ РНКБ', max_digits=10, decimal_places=2, default=0)
    reserv_rosbank_rub = models.DecimalField('РЕЗЕРВ РОСБАНК', max_digits=10, decimal_places=2, default=0)
    reserv_mtsbank_rub = models.DecimalField('РЕЗЕРВ МТСБАНК', max_digits=10, decimal_places=2, default=0)
# ПС
    reserv_qiwi_rub = models.DecimalField('РЕЗЕРВ КИВИРУБ', max_digits=10, decimal_places=2, default=0)
    reserv_qiwi_usd = models.DecimalField('РЕЗЕРВ КИВИДОЛЛАР', max_digits=10, decimal_places=2, default=0)
    reserv_payeer_rub = models.DecimalField('РЕЗЕРВ ПАЕЕРРУБ', max_digits=10, decimal_places=2, default=0)
    reserv_payeer_usd = models.DecimalField('РЕЗЕРВ ПАЕЕРДОЛЛАР', max_digits=10, decimal_places=2, default=0)
    reserv_payeer_eur = models.DecimalField('РЕЗЕРВ ПАЕЕРЕВРО', max_digits=10, decimal_places=2, default=0)
    reserv_webmoney_rub = models.DecimalField('РЕЗЕРВ ВЕБМАНИРУБ', max_digits=10, decimal_places=2, default=0)
    reserv_webmoney_usd = models.DecimalField('РЕЗЕРВ ВЕБМАНИДОЛЛАР', max_digits=10, decimal_places=2, default=0)
    reserv_webmoney_eur = models.DecimalField('РЕЗЕРВ ВЕБМАНИЕВРО', max_digits=10, decimal_places=2, default=0)
    reserv_pm_btc = models.DecimalField('РЕЗЕРВ ПМБИТКОИН', max_digits=10, decimal_places=8, default=0)
    reserv_pm_usd = models.DecimalField('РЕЗЕРВ ПМДОЛЛАР', max_digits=10, decimal_places=2, default=0)
    reserv_pm_eur = models.DecimalField('РЕЗЕРВ ПМЕВРО', max_digits=10, decimal_places=2, default=0)
    reserv_skrill_eur = models.DecimalField('РЕЗЕРВ СКРИЛЛЕВРО', max_digits=10, decimal_places=2, default=0)
    reserv_skrill_usd = models.DecimalField('РЕЗЕРВ СКРИЛДОЛЛАР', max_digits=10, decimal_places=2, default=0)
    reserv_paypal_rub = models.DecimalField('РЕЗЕРВ ПАЙПАЛРУБ', max_digits=10, decimal_places=2, default=0)
    reserv_paypal_usd = models.DecimalField('РЕЗЕРВ ПАЙПАЛДОЛЛАР', max_digits=10, decimal_places=2, default=0)
    reserv_paypal_eur = models.DecimalField('РЕЗЕРВ ПАЙПАЛЕВРО', max_digits=10, decimal_places=2, default=0)
    reserv_umoney_rub = models.DecimalField('РЕЗЕРВ ЮМАНИ', max_digits=4, decimal_places=2, default=0)
# КРИПТА
    reserv_btc = models.DecimalField('РЕЗЕРВ БИТКОИН', max_digits=10, decimal_places=8, default=0)
    reserv_xrp = models.DecimalField('РЕЗЕРВ РИПЛ', max_digits=10, decimal_places=8, default=0)
    reserv_ltc = models.DecimalField('РЕЗЕРВ ЛАЙТКОИН', max_digits=10, decimal_places=8, default=0)
    reserv_bch = models.DecimalField('РЕЗЕРВ БИТКОИНКЕШ', max_digits=10, decimal_places=8, default=0)
    reserv_xmr = models.DecimalField('РЕЗЕРВ МОНЕРО', max_digits=10, decimal_places=8, default=0)
    reserv_eth = models.DecimalField('РЕЗЕРВ ЭФИР', max_digits=10, decimal_places=8, default=0)
    reserv_etc = models.DecimalField('РЕЗЕРВ ЭФИРКЛАССИК', max_digits=10, decimal_places=8, default=0)
    reserv_dash = models.DecimalField('РЕЗЕРВ ДАШ', max_digits=10, decimal_places=8, default=0)
...
# БАНКИ
    ...
    comis_in_psb_rub = models.DecimalField('КОММИСИЯ НА ПОПОЛНЕНИЕ ПСБ', max_digits=10, decimal_places=2, default=0)
